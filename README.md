...
- **`dataset/benign/F-Droid/`** — collected F-Droid open-source APKs (benign by nature with 2805 APKs). https://huggingface.co/datasets/HydraDragonAntivirus/BenignAPKDataset/tree/main (uploaded via "set HF_HUB_DISABLE_XET=1;hf upload HydraDragonAntivirus/BenignAPKDataset dataset\benign --repo-type=dataset")
