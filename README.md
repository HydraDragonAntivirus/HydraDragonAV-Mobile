...
- **`dataset/benign/F-Droid/`** — collected F-Droid open-source APKs (benign by nature with 2805 APKs). If you can host my benign APK dataset please let me know! I only can post this to TeraBox due to size.
