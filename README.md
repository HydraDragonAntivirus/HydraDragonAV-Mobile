...
- **`dataset/benign/F-Droid/`** — collected F-Droid open-source APKs (benign by nature with 2805 APKs). https://huggingface.co/datasets/HydraDragonAntivirus/BenignAPKDataset/tree/main
