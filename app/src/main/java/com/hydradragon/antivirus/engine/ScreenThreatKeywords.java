...
public final class ScreenThreatKeywords {
    ...
    public static final String[] RANSOMWARE = {
        ...
        "install tor browser", "download tor", "your company is fully", "files will be decrypted",
        "contact us", "decrypt 1 file", "has been encrypted", "contact information",
        "pay the ransom", "decryption id", "are encrypted", "your files have been encrypted",
        // Turkish
        "dosyalarınız şifrelendi", "bitcoin ödeyin", "dosyalarınızı kurtarın", "bitcoin adresi",
        "dosyalarınız kilitlendi", "tor tarayıcıyı yükleyin", "tor indir", "şirketiniz tamamen",
        "dosyaların şifresi çözülecek", "bize ulaşın", "1 dosyanın şifresini çöz",
        "şifrelendi", "iletişim bilgileri", "fidyeyi ödeyin", "şifre çözme kimliği",
        "şifrelenmiş", "dosyalarınız şifrelenmiş",
        // Spanish
        "sus archivos han sido cifrados", "pague bitcoin", "recupere sus archivos", "dirección de bitcoin",
        "instale el navegador tor", "descargar tor", "su empresa está completamente",
        "los archivos serán descifrados", "contáctenos", "descifrar 1 archivo",
        "ha sido cifrado", "información de contacto", "pague el rescate", "id de descifrado",
        "están cifrados", "sus archivos han sido cifrados",
        // German
        "ihre dateien wurden verschlüsselt", "bitcoin bezahlen", "stellen sie ihre dateien wieder her",
        "tor-browser installieren", "tor herunterladen", "ihr unternehmen ist vollständig",
        "dateien werden entschlüsselt", "kontaktieren sie uns", "1 datei entschlüsseln",
        "wurde verschlüsselt", "kontaktinformationen", "lösegeld zahlen", "entschlüsselungs-id",
        "sind verschlüsselt", "ihre dateien sind verschlüsselt",
        // French
        "vos fichiers ont été chiffrés", "payez en bitcoin", "récupérez vos fichiers",
        "installez le navigateur tor", "télécharger tor", "votre entreprise est entièrement",
        "les fichiers seront déchiffrés", "contactez-nous", "déchiffrer 1 fichier",
        "a été chiffré", "informations de contact", "payez la rançon", "id de déchiffrement",
        "sont chiffrés", "vos fichiers sont chiffrés",
        // Russian
        "ваши файлы зашифрованы", "оплатите биткоин", "восстановите ваши файлы",
        "установите tor браузер", "скачать tor", "ваша компания полностью",
        "файлы будут расшифрованы", "свяжитесь с нами", "расшифровать 1 файл",
        "был зашифрован", "контактная информация", "заплатите выкуп", "id расшифровки",
        "зашифрованы", "ваши файлы были зашифрованы",
        // Portuguese
        "seus arquivos foram criptografados", "pague em bitcoin", "recupere seus arquivos",
        "instale o navegador tor", "baixar tor", "sua empresa está completamente",
        "os arquivos serão descriptografados", "fale conosco", "descriptografar 1 arquivo",
        "foi criptografado", "informações de contato", "pague o resgate", "id de descriptografia",
        "estão criptografados", "seus arquivos foram criptografados",
        // Arabic
        "تم تشفير ملفاتك", "ادفع بيتكوين", "استرجع ملفاتك",
        "قم بتثبيت متصفح تور", "تحميل تور", "شركتك بالكامل",
        "سيتم فك تشفير الملفات", "اتصل بنا", "فك تشفير ملف واحد",
        "تم تشفيره", "معلومات الاتصال", "ادفع الفدية", "معرف فك التشفير",
        "مشفرة", "ملفاتك مشفرة",
        // Italian
        "i tuoi file sono stati crittografati", "paga in bitcoin", "recupera i tuoi file",
        "indirizzo bitcoin", "installa il browser tor", "scarica tor", "la tua azienda è completamente",
        "i file verranno decifrati", "contattaci", "decifra 1 file",
        "è stato crittografato", "informazioni di contatto", "paga il riscatto", "id di decifratura",
        "sono crittografati", "i tuoi file sono crittografati",
        // Dutch
        "uw bestanden zijn versleuteld", "betaal bitcoin", "herstel uw bestanden", "bitcoin-adres",
        "tor-browser installeren", "tor downloaden", "uw bedrijf is volledig",
        "bestanden worden ontsleuteld", "neem contact met ons op", "1 bestand ontsleutelen",
        "is versleuteld", "contactgegevens", "betaal het losgeld", "ontsleutelings-id",
        "zijn versleuteld", "uw bestanden zijn versleuteld",
        // Polish
        "twoje pliki zostały zaszyfrowane", "zapłać bitcoinem", "odzyskaj swoje pliki",
        "adres bitcoin", "zainstaluj przeglądarkę tor", "pobierz tor", "twoja firma jest w pełni",
        "pliki zostaną odszyfrowane", "skontaktuj się z nami", "odszyfruj 1 plik",
        "został zaszyfrowany", "informacje kontaktowe", "zapłać okup", "id deszyfrowania",
        "są zaszyfrowane", "twoje pliki są zaszyfrowane",
        // Ukrainian
        "ваші файли зашифровані", "заплатіть біткоїн", "відновіть свої файли",
        "встановіть tor браузер", "завантажити tor", "ваша компанія повністю",
        "файли буде розшифровано", "зв'яжіться з нами", "розшифрувати 1 файл",
        "було зашифровано", "контактна інформація", "заплатіть викуп", "id розшифрування",
        "зашифровані", "ваші файли зашифровані",
        // Chinese (Simplified)
        "您的文件已被加密", "支付比特币", "恢复您的文件", "比特币地址",
        "安装tor浏览器", "下载tor", "您的公司已完全",
        "文件将被解密", "联系我们", "解密1个文件",
        "已被加密", "联系信息", "支付赎金", "解密编号",
        "已加密", "您的文件已被加密",
        // Japanese
        "ファイルは暗号化されました", "ビットコインで支払う", "ファイルを復元する", "ビットコインアドレス",
        "torブラウザをインストール", "torをダウンロード", "あなたの会社は完全に",
        "ファイルは復号されます", "お問い合わせ", "1ファイルを復号",
        "暗号化されました", "連絡先情報", "身代金を支払う", "復号id",
        "暗号化されている", "あなたのファイルは暗号化されています",
        // Korean
        "파일이 암호화되었습니다", "비트코인으로 결제하세요", "파일을 복구하세요", "비트코인 주소",
        "tor 브라우저 설치", "tor 다운로드", "귀사의 파일이 완전히",
        "파일이 복호화됩니다", "문의하기", "1개 파일 복호화",
        "암호화되었습니다", "연락처 정보", "몸값을 지불하세요", "복호화 id",
        "암호화됨", "귀하의 파일이 암호화되었습니다",
        // Hindi
        "आपकी फ़ाइलें एन्क्रिप्ट कर दी गई हैं", "बिटकॉइन का भुगतान करें", "अपनी फ़ाइलें पुनर्प्राप्त करें",
        "tor ब्राउज़र स्थापित करें", "tor डाउनलोड करें", "आपकी कंपनी पूरी तरह से",
        "फ़ाइलें डिक्रिप्ट की जाएंगी", "हमसे संपर्क करें", "1 फ़ाइल डिक्रिप्ट करें",
        "एन्क्रिप्ट किया गया", "संपर्क जानकारी", "फिरौती दें", "डिक्रिप्शन आईडी",
        "एन्क्रिप्टेड हैं", "आपकी फ़ाइलें एन्क्रिप्टेड हैं",
        // Indonesian
        "file anda telah dienkripsi", "bayar bitcoin", "pulihkan file anda", "alamat bitcoin",
        "instal browser tor", "unduh tor", "perusahaan anda sepenuhnya",
        "file akan didekripsi", "hubungi kami", "dekripsi 1 file",
        "telah dienkripsi", "informasi kontak", "bayar tebusan", "id dekripsi",
        "dienkripsi", "file anda telah dienkripsi",
        // Vietnamese
        "các tệp của bạn đã được mã hóa", "thanh toán bằng bitcoin", "khôi phục tệp của bạn",
        "cài đặt trình duyệt tor", "tải xuống tor", "công ty của bạn hoàn toàn",
        "các tệp sẽ được giải mã", "liên hệ với chúng tôi", "giải mã 1 tệp",
        "đã được mã hóa", "thông tin liên hệ", "trả tiền chuộc", "id giải mã",
        "đã mã hóa", "tệp của bạn đã được mã hóa",
        // Persian
        "فایل‌های شما رمزگذاری شده‌اند", "بیت‌کوین پرداخت کنید", "فایل‌های خود را بازیابی کنید",
        "مرورگر tor را نصب کنید", "دانلود tor", "شرکت شما به طور کامل",
        "فایل‌ها رمزگشایی خواهند شد", "با ما تماس بگیرید", "رمزگشایی 1 فایل",
        "رمزگذاری شده است", "اطلاعات تماس", "باج را پرداخت کنید", "شناسه رمزگشایی",
        "رمزگذاری شده‌اند", "فایل‌های شما رمزگذاری شده‌اند",
        // Thai
        "ไฟล์ของคุณถูกเข้ารหัสแล้ว", "จ่ายเป็นบิตคอยน์", "กู้คืนไฟล์ของคุณ",
        "ติดตั้งเบราว์เซอร์ tor", "ดาวน์โหลด tor", "บริษัทของคุณถูก",
        "ไฟล์จะถูกถอดรหัส", "ติดต่อเรา", "ถอดรหัส 1 ไฟล์",
        "ถูกเข้ารหัสแล้ว", "ข้อมูลติดต่อ", "จ่ายค่าไถ่", "รหัสการถอดรหัส",
        "ถูกเข้ารหัส", "ไฟล์ของคุณถูกเข้ารหัส",
    };
