...
# scanner loads.
#
# ALL filters use BinaryFuse16 (~2.16 bytes/key): best size/accuracy tradeoff
# for URL/domain/IP blocklists and the MD5 whitelist (all_md5.txt -> step 4/4).
#
# Pipeline:
